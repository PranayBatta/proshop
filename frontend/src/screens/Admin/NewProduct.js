...
function NewProduct() {
  ...
  const dispatch=useDispatch();
    ...
    const submithandler=(e)=>{
        ...
        const CreateProduct=()=>{dispatch(actions.createProduct(userInfo.token,formdata))}
        CreateProduct()
        navigate('/products')
    }
...
<Form onSubmit={submithandler}>
    <Row>
        <Col md={4}>  
        {/* <Image src={`http://127.0.0.1:8000`} fluid className='my-3'></Image> */}
    ...
    <Button type='submit' variant='primary' className='my-3'>Create Product</Button>
</Form>
</Container>
    </>
  )
